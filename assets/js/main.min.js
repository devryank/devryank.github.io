var scrollTop=$(window).scrollTop(),elementOffset=$("nav").offset().top,distance=elementOffset-scrollTop;function show_section(a,s,i){"top"==s?(i="",marginNav=-150):marginNav="",a!=s&&$("#"+a).animate({opacity:0},800,function(){if("top"==s)$("nav").css("top",""),$("nav").css("margin-top","0"),$("nav").animate({top:distance},800,function(){$("nav").css("top","").css("margin-top","-150px"),$("#"+a).removeClass("h-100"),$("#"+a+">.container").remove(),$("#"+s).addClass("h-100"),show_top()});else if("top"==a)$("nav").css("margin-top",""),$("nav").animate({top:i,marginTop:0},800,function(){switch($("#"+a).removeClass("h-100"),$("#"+a+">.container").remove(),$("#"+s).css("top","50"),s){case"experience":show_experience();break;case"skills":show_skills();break;case"projects":show_projects()}});else switch($("nav").css("top","20"),$("#"+a).removeClass("h-100"),$("#"+a+">.container").remove(),s){case"experience":show_experience();break;case"skills":show_skills();break;case"projects":show_projects()}})}function show_top(){$("#top").html(`<div class="container h-100">
